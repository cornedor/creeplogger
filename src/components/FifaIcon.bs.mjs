...
function make(props) {
  ...
  return JsxRuntime.jsx("svg", (newrecord.xmlns = "http://www.w3.org/2000/svg", newrecord.viewBox = "0 0 24 24", newrecord.fill = "currentColor", newrecord.width = "1em", newrecord.height = "1em", newrecord["aria-hidden"] = true, newrecord.children = JsxRuntime.jsx("path", {
