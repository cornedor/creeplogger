...
import * as EmulatorSetupJs from "./EmulatorSetup.js";

var databaseURL = (process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || process.env.NEXT_PUBLIC_DATABASE_URL);
...
EmulatorSetupJs.setupFirebaseEmulator(database);
